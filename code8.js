...
gdjs.SertificateCode.GDposttestObjects1= [];
gdjs.SertificateCode.GDposttestObjects2= [];
...
gdjs.SertificateCode.GDlinkObjects1= [];
gdjs.SertificateCode.GDlinkObjects2= [];
gdjs.SertificateCode.GDSettingsMarker2Objects1= [];
gdjs.SertificateCode.GDSettingsMarker2Objects2= [];
gdjs.SertificateCode.GDMovementObjects1= [];
gdjs.SertificateCode.GDMovementObjects2= [];
gdjs.SertificateCode.GDMarker2Objects1= [];
gdjs.SertificateCode.GDMarker2Objects2= [];


gdjs.SertificateCode.mapOfGDgdjs_9546SertificateCode_9546GDposttestObjects1Objects = Hashtable.newFrom({"posttest": gdjs.SertificateCode.GDposttestObjects1});
...
{gdjs.evtTools.window.openURL("https://forms.gle/wQDEmsHwhh5kGv3t7", runtimeScene);
}}

}


};gdjs.SertificateCode.eventsList1 = function(runtimeScene) {
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Marker"), gdjs.SertificateCode.GDMarkerObjects1);
...
}{gdjs.evtTools.tween.tweenCamera2(runtimeScene, "CameraMove", (( gdjs.SertificateCode.GDMarkerObjects1.length === 0 ) ? 0 :gdjs.SertificateCode.GDMarkerObjects1[0].getCenterXInScene()), gdjs.evtTools.camera.getCameraY(runtimeScene, "", 0), "", "easeInQuad", 1);
}{for(var i = 0, len = gdjs.SertificateCode.GDMarkerObjects1.length ;i < len;++i) {
    gdjs.SertificateCode.GDMarkerObjects1[i].hide();
}
}{for(var i = 0, len = gdjs.SertificateCode.GDTransition2Objects1.length ;i < len;++i) {
    gdjs.SertificateCode.GDTransition2Objects1[i].getBehavior("FlashTransitionPainter").PaintEffect("0;0;0", 1, "Circular", "Backward", 0, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
...
gdjs.copyArray(runtimeScene.getObjects("posttest"), gdjs.SertificateCode.GDposttestObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.SertificateCode.mapOfGDgdjs_9546SertificateCode_9546GDposttestObjects1Objects, runtimeScene, true, false);
if (isConditionTrue_0) {

{ //Subevents
gdjs.SertificateCode.eventsList0(runtimeScene);} //End of subevents
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.SertificateCode.GDposttestObjects1.length;i<l;++i) {
    if ( gdjs.SertificateCode.GDposttestObjects1[i].getBehavior("ButtonFSM").IsHovered((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.SertificateCode.GDposttestObjects1[k] = gdjs.SertificateCode.GDposttestObjects1[i];
        ++k;
    }
}
gdjs.SertificateCode.GDposttestObjects1.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.SertificateCode.GDposttestObjects1 */
{for(var i = 0, len = gdjs.SertificateCode.GDposttestObjects1.length ;i < len;++i) {
    gdjs.SertificateCode.GDposttestObjects1[i].getBehavior("Effect").enableEffect("Effect", true);
}
}}
...
/* Reuse gdjs.SertificateCode.GDposttestObjects1 */
{for(var i = 0, len = gdjs.SertificateCode.GDposttestObjects1.length ;i < len;++i) {
    gdjs.SertificateCode.GDposttestObjects1[i].getBehavior("Effect").enableEffect("Effect", false);
}
}}
...
gdjs.SertificateCode.GDposttestObjects1.length = 0;
gdjs.SertificateCode.GDposttestObjects2.length = 0;
...
gdjs.SertificateCode.GDlinkObjects1.length = 0;
gdjs.SertificateCode.GDlinkObjects2.length = 0;
gdjs.SertificateCode.GDSettingsMarker2Objects1.length = 0;
gdjs.SertificateCode.GDSettingsMarker2Objects2.length = 0;
gdjs.SertificateCode.GDMovementObjects1.length = 0;
gdjs.SertificateCode.GDMovementObjects2.length = 0;
gdjs.SertificateCode.GDMarker2Objects1.length = 0;
gdjs.SertificateCode.GDMarker2Objects2.length = 0;

gdjs.SertificateCode.eventsList1(runtimeScene);
gdjs.SertificateCode.GDLoseObjects1.length = 0;
gdjs.SertificateCode.GDLoseObjects2.length = 0;
gdjs.SertificateCode.GDTry_9595AgainObjects1.length = 0;
gdjs.SertificateCode.GDTry_9595AgainObjects2.length = 0;
